...
public void tearDown(){
    ...
    public void  dynamic_loading_1(){
        ...
        loopPracticeDynamicLoading1.username.sendKeys(ConfigurationReader.getProperty("dynamic.loading.username"));
        loopPracticeDynamicLoading1.password.sendKeys(ConfigurationReader.getProperty("dynamic.loading.incorrect.password"));
        loopPracticeDynamicLoading1.submitButton.click();
        assertTrue(loopPracticeDynamicLoading1.errorMessage.isDisplayed());
    }
